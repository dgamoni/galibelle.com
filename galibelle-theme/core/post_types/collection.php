...
function collection_custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Collection', '', 'galibelle' ),
		'singular_name'         => _x( 'Collection', '', 'galibelle' ),
		'menu_name'             => __( 'Collection', 'galibelle' ),
		'name_admin_bar'        => __( 'Collection', 'galibelle' ),
