...
function brand_custom_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Brand', '', 'galibelle' ),
		'singular_name'         => _x( 'Brand', '', 'galibelle' ),
		'menu_name'             => __( 'Brand', 'galibelle' ),
		'name_admin_bar'        => __( 'Brand', 'galibelle' ),
...
add_action( 'init', 'brand_custom_post_type', 0 );  