...
function city_custom_taxonomy() {

	$labels = array(
		'name'                       => _x( 'City', 'Taxonomy General Name', 'galibelle' ),
		'singular_name'              => _x( 'City', 'Taxonomy Singular Name', 'galibelle' ),
		'menu_name'                  => __( 'City', 'galibelle' ),
	...
	register_taxonomy( 'city', array( 'shops' ), $args );

}
add_action( 'init', 'city_custom_taxonomy', 0 ); 